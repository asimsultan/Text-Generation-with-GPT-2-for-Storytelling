...
def main(data_path):
    ...
    # DataLoader
    train_dataset = StoryDataset(tokenized_datasets['train'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, required=True, help='Path to the CSV file containing story data')
